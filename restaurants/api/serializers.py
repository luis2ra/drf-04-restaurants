...
class RestaurantSerializer(serializers.ModelSerializer):
    # Serializer for the Restaurant model, in fields we specify the model 
    # attributes we want to deserialize and serialize
    class Meta:
...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    # the image in the function 'encode_thumbnail' were the image is read from 
    # the media folder and encoded into base64
    thumbnail = serializers.SerializerMethodField('encode_thumbnail')
    # When getting a recipe I want an 'ingredients' field, the value of this 
    # field is the return of the get_ingredients function that serializes the 
    ...
    def create(self, validated_data):
        """
        Create function for recipes, a restaurant and a list of ingredients is 
        asociated. The restaurantId is taken from the corresponding path parameter 
        and the ingredients can be added optionally in the post body.
        """
